...
% 20150831 GMW  Vectorized. Now accept 2-column matrix inputs as well.
%               Each must have same # of rows.
%--------------------------------------------------------------------------

%size check
if size(latlon1,1) ~= size(latlon2,1)
    error('Inputs must have same # of rows.')
end
